...
class Controller {
    ...
    public function init() {      
        ...
        //Parse URI       
        list(self::$instance->route, self::$instance->requestVars) = self::$instance->parseURI($URI);       
        
//        self::$instance->view = View::getInstance();
//        self::$instance->view->init();
        if(!self::$instance->load(self::$instance->route)){       
            self::$instance->load(Config::get('route_404'));
        }
        //self::$instance->view->flush();
    }
    ...
    protected function view(){//index/index
